...
const BuyNow = () => {
    ...
    const handelAdOrder = event => {
        ...
        const order = { productName, email, phone, address, quantity }
                ...
                <div className='_id-product'>
                    ...
                    <div className="_id-product-delivery-notice">
                        ...
                        <div className="home-delivery">
                            ...
                            <p> Home Delivery: Free <br /> <span>Only inside in USA</span></p>
                        </div>
                        ...
                        <form onSubmit={handelAdOrder} className='form-container'>
                            ...
                            <div className="email-area">
                                ...
                                <div className="user-phone">
                                    <input type="number" name="phone" id="" placeholder='+880example@123' />
                                </div>
                            </div> <br />
                            <div className="email-area">
                                <div className="email-title">
                            ...
                            <div className="email-area">
                                ...
                                <div className="product-quantity">
                                    <input type="number" name="quantity" id="" placeholder='100/p' />
                                </div>
                            </div> <br />
